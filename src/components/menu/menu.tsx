...
export class Menu extends Component<any, MenuState>{
    ...
    public isUnderLine = (index: number) => {
        console.log(this.state.underlinesList);
        ...
        return (
            <div className="menu">
                <div onMouseEnter={this.fillUnderLine}
                    ...
                    className={"menu-item item-1 " + this.isActive(1) + this.isUnderLine(1)}>
                ...
                <div onMouseEnter={this.fillUnderLine}
                    onMouseLeave={() => this.setState({ underlinesList: [] })}
                    className={"menu-item item-2 " + this.isActive(2) + this.isUnderLine(2)}>
                    <a href="#projects" onClick={this.changeDisplay(2)}>
                        Projects
                        </a>
                </div>
                <div onMouseEnter={this.fillUnderLine}
                ...
                <div onMouseEnter={this.fillUnderLine}
                    onMouseLeave={() => this.setState({ underlinesList: [] })}
                    className={"menu-item item-4 " + this.isActive(4) + this.isUnderLine(4)}>
                    <a href="#technologies" onClick={this.changeDisplay(4)}>
                        Tech stack
                        </a>
                </div>
            </div>
